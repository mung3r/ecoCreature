...
public class ItemDrop
{
    ...
    {
        if (name == null || org.bukkit.enchantments.Enchantment.getByName(name.toUpperCase()) == null) {
            throw new IllegalArgumentException();
        }
        ItemEnchantment enchantment = new ItemEnchantment();
        enchantment.setEnchantment(org.bukkit.enchantments.Enchantment.getByName(name.toUpperCase()));
