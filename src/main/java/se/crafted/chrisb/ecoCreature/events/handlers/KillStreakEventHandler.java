...
public class KillStreakEventHandler extends AbstractEventHandler
{
    ...
    {
        return event instanceof KillStreakEvent ? Lists.newArrayList(createRewardEvents((KillStreakEvent) event)) : EMPTY_COLLECTION;
    }

    private Collection<RewardEvent> createRewardEvents(KillStreakEvent event)
    {
